...
import styles from '../routes/discover/Index.scss'
...
class AudioProcess extends React.Component{
  ...
  render(){
    return <div className={styles.cav}><canvas className={styles.canvas} width="100" height="100" ref="canvas"></canvas> </div>
  }
}
