...
// import style from './DistinguishPage.scss'
// import {connect} from 'dva'
// import {randomArr} from '../utils/index'

// class DistinguishPage extends React.PureComponent{
//     constructor(){
//         super()
//     }
//     render(){
//         return(
//             <div className="DistinguishPage">
//                 disdsd
//             </div>
//         )
//     }
...
class Distinguish extends React.PureComponent{
  ...
  static getDerivedStateFromProps(props, state){
    console.log(props.distiguishList)
    return {
